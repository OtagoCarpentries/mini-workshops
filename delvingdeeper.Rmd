...
`[` will depending on the data structure either return the original structure, or reduce the dimensions of the returned structure. Use the `[` for 1 dimensional structures. Be careful when subsetting factors.
...
- Find
- Create a variable called `luke_films` and assign the list of films that Luke Skywalker was in to it
